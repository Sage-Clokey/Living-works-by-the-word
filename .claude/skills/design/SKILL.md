---
name: design
description: Industry-specific UI/UX design advisor. Provides color palettes, typography pairings, layout patterns, and anti-pattern warnings for any industry. Use when the user asks for design recommendations, design advice, or wants to know how to style a project.
